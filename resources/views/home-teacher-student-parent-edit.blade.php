                            ...
                            <form action="{{ action('ParentController@update',['id'=>$student->id]) }}" method="POST">
                                ...
                                <div class="columns">
                                    ...
                                    <div class="column">
                                        ...
                                        <p class="control">
                                            <input class="input" name="address" type="text" placeholder="Complete Address" value="{{ old('address') ?: $student->parent->address }}" >
                                        </p>
                                        <label class="label">Contact Number</label>
                                        <p class="control">
                                            <input class="input" name="contact" type="text" placeholder="Contact Number" value="{{ old('contact') ?: $student->parent->contact }}" >
                                        </p>
                                    </div>
                                </div>
                            </form>
