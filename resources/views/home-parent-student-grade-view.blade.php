                            ...
                            <form action="" method="POST">
                                ...
                                <div class="columns is-multiline">
                                    <div class="column is-full">
                                        ...
                                        <p class="control">
                                            <input class="input{{ $errors->has('name') ? ' is-danger' : '' }}" name="name" type="text" placeholder="Your Name" readonly value="{{ $student->name }}" >
                                        </p>
                                        <hr>
                                    </div>
                                        ...
                                        <div class="column is-full">
                                            <div class="columns">
                                                ...
                                                <div class="column is-2">
                                                    <p class="control">
                                                        <input class="input" type="text" readonly=" "value="{{ $student->grade()->where(['subject_id' => $subject->id])->value('grade') }}%">
                                                    </p>
                                                </div>
                                            </div>
